...
export default function Footer({ onNavigate }: FooterProps) {
  return (
    <footer
      id="app-footer"
      className="bg-slate-900 text-slate-400 py-16 border-t border-slate-800 rounded-t-[40px] mt-16 w-full"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-slate-800 pb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-sm">
              AI Powered Civic Reporting Platform. Empowers citizens and
              optimizes municipal responses through intelligent machine
              analysis.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 leading-relaxed mb-4">
              This software engineering project showcases full-stack web
              integration:
            </p>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={tech}
                  className="bg-slate-800 text-slate-300 text-[10px] font-mono px-2.5 py-1 rounded-md border border-slate-700/50"
                >
                  {tech}
                </span>
              ))}
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 space-y-4 sm:space-y-0">
          <span>
            &copy; {new Date().getFullYear()} Community Hero. Open-source
            municipal software initiative.
          </span>
